        ...
        <section class="container-fluid about-section section first-section-shadow">
            ...
            <div class="row">
                <div class="col-sm-12 col-xs-12 text-center">
                    <h1 class="section-headings">About us</h1>
                </div>
            </div>
            ...
            <div class="row about-text">
                ...
                <div class="col-sm-12 col-xs-12">
                    ...
                    <img data-280="opacity: .88;" data-500="opacity: 1;" src="../images/assets/zoo-index-page/about-image.jpg" class="img-responsive image-center"/>
                ...
                <div class="leaf-1-container"
                    ...
                    <img src="../images/assets/zoo-index-page/home-leaf-1.jpg" class="img-responsive"/>
                </div>

                <div class="leaf-2-container"
                     data-100="opacity: 0;margin-right: -250px;" 
                     data-350="opacity: 1;margin-right: 0px;">
                    <img src="../images/assets/zoo-index-page/home-leaf-2.jpg" class="img-responsive"/>
                </div>

                <div class="leaf-3-container"
                     data-150="opacity: 0;margin-left: -450px;" 
                     data-450="opacity: 1;margin-left: 0px;">
                    <img src="../images/assets/zoo-index-page/home-leaf-3.jpg" class="img-responsive"/>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 margin-sm-60 current-scene text-center">
                        <img src="../images/assets/zoo-index-page/current-scene.svg" class="" />
                ...
                <div class="row our-scene">
                    <div class="col-sm-4 col-xs-12 no-padding">
                        ...
                        <a href="about.php" class="read-more-link">
                            <img src="../images/assets/zoo-index-page/arrorw.svg" class="" />
                            READ MORE
                        </a>
