...
?>
    ...
    <div class="zoo-about-page-container">
        ...
        <section class="container-fluid section pt-0">
            ...
            <div class="container">
                ...
                <div class="row divided-text-section">
                    ...
                    <div class="col-sm-6 col-xs-12 text-left">
                        ...
                        <ul>
                            <li>Touch and feel</li>
                            <li>‘Pick and chose’ purchasing for customers</li>
                            <li>Available at your doorstep at any time through CropZoo app</li>
                            <li>Order online, COD, Monthly subscriptions or pick from your own hands.</li>
                            <li>SMS updates on delivery</li> 
                        </ul>
                        ...
                        <ul>
                            ...
                            <li>Consistent & standard pricing</li>
                            <li>Automated bill for every purchase</li>
                            <li>SMS updates on delivery</li> 
                        </ul>
                        ...
                        <ul>
                            <li>Digital weighing scale (dual display) </li>
                            <li>Self picking, Self weighing</li>
                            <li>Transparent and accurate weight management</li>
                            <li>Comparison price charts displayed</li>
                        </ul>

                        <p class="sub-heading">
                            HYGIENE & VISUAL APPEAL      
                        </p>
                        <ul>
                            <li>Clean and well stocked</li>
                            <li>Fruits and vegetables displayed in organized food grade crates</li>
                            <li>Shielded from sunlight and dust</li>
                        </ul>

                        <p class="sub-heading">
                            OZONE PURIFIER USED FOR CLEANING FRUITS & VEGETABLES      
                        </p>
                        <p>Ozonization purifies the vegetables against pesticides and harmful bacteria such as E Coli and salmonella. It is also free from the wax some vendors use to polish fruits to give them sheen.</p>
